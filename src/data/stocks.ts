export const STRATEGIES = [
  ...
  { id: 'CUP_HANDLE_ABCD', name: 'Structural Pivot', baskets: ['HIGH_BETA', 'PROFIT'], isLive: true, tier: 'pro' },
  { id: 'RHS_ABCD', name: 'Dynamic Reversal', baskets: ['HIGH_BETA', 'PROFIT'], isLive: true, tier: 'pro' },
  { id: '52W_HIGH_LOW', name: 'Annual Range Matrix', baskets: ['HIGH_BETA', 'PROFIT'], isLive: true, tier: 'pro' },
  { id: 'SMA_ABCD', name: 'Quantum Stacking', baskets: ['BLUECHIP', 'HIGH_BETA', 'PROFIT'], isLive: true, tier: 'pro' },
  { id: 'TWENTY_RALLY_RETEST', name: 'Velocity Retest', baskets: ['HIGH_BETA', 'PROFIT'], isLive: true, tier: 'alpha' },
