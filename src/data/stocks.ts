export const STRATEGIES = [
  ...
  { id: 'REVERSE_HEAD_SHOULDERS', name: 'Reverse Head & Shoulders (RHS)', baskets: ['Elite Basket', 'Quality Basket'], isLive: true, tier: 'alpha', isLocked: true },
...
export const BASKETS: Record<string, string[]> = {
  'Elite Basket': [
    ...
    'BHARTIARTL', 'M&M', 'MARUTI', 'TMCV', 'SUNPHARMA', 'DRREDDY', 'CIPLA', 
