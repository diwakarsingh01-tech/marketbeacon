export const STRATEGIES = [
  { id: 'SMA', name: 'SMA Support', baskets: ['BLUECHIP', 'HIGH_BITA', 'PROFIT'], isLive: true },
  { id: 'ENVELOPE_LONG', name: 'Envelope Long', baskets: ['BLUECHIP', 'HIGH_BITA', 'PROFIT'], isLive: true },
  { id: 'BOLLINGER', name: 'Bollinger Band', baskets: ['BLUECHIP', 'HIGH_BITA', 'PROFIT'], isLive: true },
  { id: '52W_HIGH_LOW', name: '52 week High Low', baskets: ['BLUECHIP', 'HIGH_BITA', 'PROFIT'], isLive: true },
  { id: 'ENVELOPE_SHORT', name: 'Short Envelope', baskets: ['BLUECHIP'], isLive: true },
