export const STRATEGIES = [
  ...
  { id: 'CUP_HANDLE_ABCD', name: 'Structural Pivot', baskets: ['HIGH_BETA'], isLive: true, tier: 'pro' },
  { id: 'RHS_ABCD', name: 'Dynamic Reversal', baskets: ['HIGH_BETA'], isLive: true, tier: 'pro' },
  { id: '52W_HIGH_LOW', name: 'Annual Range Matrix', baskets: ['PROFIT', 'HIGH_BETA'], isLive: true, tier: 'pro' },
  { id: 'SMA_ABCD', name: 'Quantum Stacking', baskets: ['PROFIT', 'BLUECHIP'], isLive: true, tier: 'pro' },
  { id: 'TWENTY_RALLY_RETEST', name: 'Velocity Retest', baskets: ['HIGH_BETA'], isLive: true, tier: 'alpha' },
  { id: 'SIXTY_SEVEN_FUNDA', name: 'Deep Recovery Audit', baskets: ['PROFIT'], isLive: true, tier: 'alpha' },
  { id: 'SR_STRATEGY', name: 'Supply-Demand Core', baskets: ['BLUECHIP'], isLive: true, tier: 'alpha' },
];
