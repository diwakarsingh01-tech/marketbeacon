...
export const BASKETS: Record<string, string[]> = {
  'Elite Basket': [
    ...
    'SHRIRAMFIN', 'JIOFIN', 'INFOEDGE', 'ADANIENT', 'ADANIPORTS', 'APOLLOHOSP', 'BHARTIARTL', 'BPCL', 
    'BRITANNIA', 'CIPLA', 'COALINDIA', 'DIVISLAB', 'DRREDDY', 'EICHERMOT', 'GRASIM', 
    'HEROMOTOCO', 'HINDALCO', 'INDUSINDBK', 'JSWSTEEL', 'LT', 'LTIM', 'M&M', 
    'MARUTI', 'NTPC', 'ONGC', 'POWERGRID', 'SBILIFE', 'SBIN', 'SUNPHARMA', 
    'TATACONSUM', 'TATAMOTORS', 'TATASTEEL', 'TECHM', 'NIFTYBEES', 'BANKBEES'
  ],
  'Quality Basket': [
