export const STRATEGIES = [
  ...
  { id: 'RHS_CORRECTION', name: 'Reverse H&S + 10% Correction', baskets: ['H-GOOD45', 'H-Super45'], isLive: true, tier: 'pro', isLocked: true },
  ...
  { id: 'CUP_HANDLE_ABCD', name: 'Cup with Handle + ABCD', baskets: ['H-GOOD45', 'H-Super45'], isLive: true, tier: 'pro', isLocked: false },
