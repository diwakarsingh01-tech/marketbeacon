export const STRATEGIES = [
  ...
  { id: 'SMA', name: 'SMA Support', baskets: ['BLUECHIP'], isLive: true },
  { id: 'BOLLINGER', name: 'Bollinger Band', baskets: ['BLUECHIP'], isLive: true },
  { id: '52W_HIGH_LOW', name: '52 week High Low', baskets: ['BLUECHIP'], isLive: true },
  { id: 'SMA_ABCD', name: 'SMA ABCD', baskets: ['BLUECHIP', 'HIGH_BETA'], isLive: true },
