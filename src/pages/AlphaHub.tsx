...
const AlphaHubPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f8fafc] text-slate-900 overflow-hidden relative">
      ...
      {/* MAIN DATA INTERFACE */}
      <main className="flex-1 overflow-y-auto p-6 max-w-[1600px] mx-auto w-full space-y-8 pb-32 no-scrollbar">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 text-[10px] font-black text-slate-500 uppercase tracking-wider shrink-0 w-full lg:w-auto pt-4 lg:pt-0 border-t lg:border-t-0 lg:border-l border-slate-200/50 lg:pl-8">
               <div className="flex items-center gap-2">
                  ...
                  <div>
                     ...
                     <span className="text-[8px] text-slate-400">Backtested Yield</span>
                  </div>
               </div>
               <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-4.5 w-4.5 text-blue-600 shrink-0" />
                  <div>
                     ...
                     <span className="text-[8px] text-slate-400">Tailored allocations</span>
                  </div>
               </div>
               <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-4.5 w-4.5 text-blue-600 shrink-0" />
                  <div>
                     ...
                     <span className="text-[8px] text-slate-400">Zero lock-in fees</span>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24">
               ...
               <div className="bg-slate-950 border border-slate-900 rounded-[2rem] p-6 text-white space-y-6 shadow-2xl relative overflow-hidden">
                     ...
                     <div className="bg-slate-900 border border-slate-850 rounded-xl p-3.5 flex items-center justify-between shadow-inner">
                        ...
                        <div className="flex items-center gap-1">
                           ...
                           <input 
                              ...
                              className="bg-transparent text-sm font-black text-white font-mono text-right w-24 outline-none focus:text-blue-400 transition-colors"
                           />
                        </div>
                     </div>
                  </div>
                  ...
                  {/* Sizer Details */}
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-900 text-slate-400 text-[8.5px] font-black uppercase tracking-widest font-mono">
                     <div className="space-y-1">
                  ...
                  <div className="flex items-center justify-between">
                     <div className="space-y-0.5">
                       <div className="text-xl font-black text-slate-950 italic leading-none">
                          {data?.summary?.large || 0}<span className="text-[9px] text-slate-400 not-italic">L</span> • 
                          {data?.summary?.mid || 0}<span className="text-[9px] text-slate-400 not-italic">M</span> • 
                          {data?.summary?.small || 0}<span className="text-[9px] text-slate-400 not-italic">S</span>
                       </div>
                       <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest mt-1">Rule 50-30-20 Enforced</p>
                     </div>
               ...
               <div className="grid grid-cols-2 gap-4">
                  <div className="p-5 bg-white border border-slate-200 rounded-2xl space-y-1">
                     <span className="text-[7.5px] font-black text-slate-400 uppercase tracking-widest block">Entry Target Lock</span>
                  ...
                  <div className="p-5 bg-white border border-slate-200 rounded-2xl space-y-1">
                     <span className="text-[7.5px] font-black text-slate-400 uppercase tracking-widest block">Sector Hardening</span>
               ...
               <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-3.5 rounded-2xl border border-slate-200 shadow-sm">
                  <div className="flex bg-slate-100 p-1 rounded-xl border border-slate-200 w-full sm:w-auto">
                     <button 
                        ...
                        className={`flex-1 sm:flex-initial px-6 py-2.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all ${activeTab === 'active' ? 'bg-white text-slate-950 shadow-sm border border-slate-200' : 'text-slate-400 hover:text-slate-700'}`}
                     >
                        Alpha Portfolio ({data?.stocks?.length || 0})
                     </button>
                     <button 
                        onClick={() => setActiveTab('analytics')}
                        className={`flex-1 sm:flex-initial px-6 py-2.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all ${activeTab === 'analytics' ? 'bg-slate-900 text-white shadow-sm' : 'text-slate-400 hover:text-slate-700'}`}
                     >
                        Backtest Analytics
                     </button>
                     <button 
                        onClick={() => setActiveTab('closed')}
                        className={`flex-1 sm:flex-initial px-6 py-2.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all ${activeTab === 'closed' ? 'bg-white text-slate-950 shadow-sm border border-slate-200' : 'text-slate-400 hover:text-slate-700'}`}
                     >
                        Booked Profits
                     </button>
                  </div>
                  ...
                  {activeTab === 'analytics' ? (
                    ...
                    >
                     ...
                     <div className={`px-4 py-1.5 rounded-lg text-[9px] font-black text-white uppercase tracking-[0.2em] shadow-sm ${cap === 'LARGE' ? 'bg-slate-950' : cap === 'MID' ? 'bg-amber-500' : 'bg-blue-600'}`}>
                                   ...
                                   <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">{capStocks.length} Assets</span>
                                </div>
                                      ...
                                      <table className="w-full text-left border-collapse min-w-[1000px]">
                                         <thead>
                                            <tr className="bg-slate-50 border-b border-slate-200 divide-x divide-slate-100">
                                               <th className="px-5 py-4 text-[9px] font-black uppercase tracking-widest text-slate-500">Asset</th>
                                               <th className="px-5 py-4 text-[9px] font-black uppercase tracking-widest text-slate-500 text-center">Audit Score</th>
                                               <th className="px-5 py-4 text-[9px] font-black uppercase tracking-widest text-slate-500 text-right">Target ROI</th>
                                                  ...
                                                  <tr key={stock.symbol} className="hover:bg-slate-50/50 transition-all group divide-x divide-slate-50">
                                                     <td className="px-5 py-4">
                                                        <div className="flex flex-col font-sans">
                                                           <span className="text-sm font-black text-slate-900 uppercase tracking-tighter group-hover:text-blue-600 transition-colors">{stock.symbol}</span>
                                                           <span className="text-[8px] font-bold text-slate-400 uppercase tracking-widest leading-none mt-1">{stock.sector}</span>
                                                        </div>
                                                     </td>
                                                     <td className="px-5 py-4 text-center">
                                                        <span className="px-2 py-1 bg-slate-900 text-white rounded-lg text-[9px] font-black font-mono shadow-sm">{stock.score} / 9</span>
                                                     </td>
                                                     <td className="px-5 py-4 text-right">
                                                        <span className="text-sm font-black text-emerald-600">+{Number(stock.roi || 0).toFixed(1)}%</span>
                                                     </td>
                                                     <td className="px-5 py-4">
                                                        <span className="px-2 py-0.5 bg-slate-100 text-slate-600 rounded text-[8px] font-black uppercase tracking-widest border border-slate-200/50">{stock.strategy}</span>
                                                     </td>
                                                     <td className="px-5 py-4 text-right font-black text-slate-500">₹{stock.entryPrice?.toLocaleString()}</td>
                                                     <td className="px-5 py-4 text-right">
                                                     ...
                                                     <td className="px-5 py-4 text-right text-blue-600 font-black bg-blue-50/20 text-sm underline decoration-blue-100">{qty}</td>
                                                     <td className="px-5 py-4 text-right font-black bg-blue-50/20 text-slate-950">₹{Math.round(qty * (stock.currentPrice || 1)).toLocaleString()}</td>
                                                     <td className="px-5 py-4 text-center">
                                                        <Link to={`/stock/${stock.symbol}`} className="p-2 bg-slate-50 text-slate-400 hover:bg-slate-950 hover:text-white transition-all inline-flex items-center rounded-lg shadow-sm border border-slate-200">
                                            ...
                                            <div key={stock.symbol} className="p-4 space-y-3.5 hover:bg-slate-50/40 transition-colors">
                                               <div className="flex justify-between items-start">
                                                  <div>
                                                     ...
                                                     <span className="text-[8px] font-bold text-slate-400 uppercase tracking-widest block mt-0.5">{stock.sector}</span>
                                                  </div>
                                               ...
                                               <div className="grid grid-cols-2 gap-3 pt-3 border-t border-slate-100/60 text-[9px] font-bold text-slate-500 uppercase tracking-wider font-mono">
                                                  <div>
                                                     <span className="text-[7.5px] text-slate-400 block mb-0.5">Strategy</span>
                                                     <span className="text-slate-800 font-black truncate block leading-tight">{stock.strategy}</span>
                                                  </div>
                                                  <div className="text-right">
                                                     <span className="text-[7.5px] text-slate-400 block mb-0.5">Target ROI</span>
                                                     <span className="text-emerald-600 font-black">+{Number(stock.roi || 0).toFixed(1)}%</span>
                                                  </div>
                                                  <div>
                                                     <span className="text-[7.5px] text-slate-400 block mb-0.5">Base Price</span>
                                               ...
                                               <div className="pt-3 border-t border-slate-100/60 flex items-center justify-between">
                                                  <div>
                                                     <span className="text-[7.5px] text-slate-400 block mb-0.5">Total Invest</span>
                           ...
                           return (
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                 <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl text-white shadow-lg flex flex-col justify-between">
                                    ...
                                    <div className="flex items-center gap-1 font-mono">
                                       ...
                                       <input 
                                          ...
                                          className="text-xl font-black bg-transparent outline-none w-full text-white placeholder-slate-700"
                                       />
                                    </div>
                                 </div>
                                 <div className="bg-emerald-600 p-6 rounded-2xl text-white shadow-lg relative overflow-hidden group">
                                    <div className="relative z-10">
                                       <span className="text-[8px] font-black uppercase tracking-widest text-emerald-100 mb-2 block">Output Profit</span>
                                 ...
                                 <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-center">
                                    <span className="text-[8px] font-black uppercase tracking-widest text-slate-400 mb-2">Yield Realized</span>
                             ...
                             <table className="w-full text-left border-collapse min-w-[700px]">
                                <thead>
                                   <tr className="bg-slate-50 text-slate-500 border-b border-slate-200">
                                      <th className="px-6 py-5 text-[9px] font-black uppercase tracking-widest italic">Exit Date</th>
                                      <th className="px-6 py-5 text-[9px] font-black uppercase tracking-widest">Asset Ledger</th>
                                      <th className="px-6 py-5 text-[9px] font-black uppercase tracking-widest text-right">Yield Realized</th>
                                      <th className="px-6 py-5 text-[9px] font-black uppercase tracking-widest text-center">Duration</th>
                                   </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100 font-mono">
                                   {(data?.closedTrades || []).slice(0, 40).map((trade: any) => (
                                      <tr key={`${trade.symbol}-${trade.exitDate}`} className="hover:bg-slate-50 transition-all group">
                                         <td className="px-6 py-5 text-[10px] font-black text-slate-400">{new Date(trade.exitDate).toLocaleDateString(undefined, { day: '2-digit', month: 'short', year: 'numeric' })}</td>
                                         <td className="px-6 py-5">
                                            <div className="flex flex-col font-sans">
                                               <span className="text-base font-black text-slate-900 uppercase tracking-tighter group-hover:text-emerald-600 transition-colors">{trade.symbol}</span>
                                               <span className="text-[9px] font-black text-blue-600 uppercase tracking-widest leading-none mt-1">{trade.sector}</span>
                                            </div>
                                         </td>
                                         <td className="px-6 py-5 text-lg font-black text-right text-emerald-600">+{Number(trade.roi).toFixed(1)}%</td>
                                         <td className="px-6 py-5 text-center">
                                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-150 rounded-xl text-[9px] font-black text-slate-900 uppercase tracking-widest shadow-sm">
                              ...
                              {(data?.closedTrades || []).slice(0, 40).map((trade: any) => (
                                 <div key={`${trade.symbol}-${trade.exitDate}`} className="p-4 space-y-3.5 hover:bg-slate-50/40 transition-colors">
                                    <div className="flex justify-between items-start">
                                       ...
                                       <div className="text-right">
                                          <span className="text-[7.5px] text-slate-400 block mb-0.5 uppercase font-bold">Exit Date</span>
                                    ...
                                    <div className="flex justify-between items-center pt-3 border-t border-slate-100/60">
                                       <div>
                                          <span className="text-[7.5px] text-slate-400 block mb-0.5 uppercase font-bold">Duration</span>
                                       ...
                                       <div className="text-right">
                                          <span className="text-[7.5px] text-slate-400 block mb-0.5 uppercase font-bold">Yield Realized</span>
                        ...
                        {Object.entries(data.summary.sectorStats).sort((a: any, b: any) => b[1] - a[1]).slice(0, 8).map(([sector, count]: any) => {
                           ...
                           return (
                              <div key={sector} className="p-4 bg-slate-50 border border-slate-100 rounded-xl space-y-1">
                                 <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest block truncate">{sector}</span>
