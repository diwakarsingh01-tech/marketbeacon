      ...
      <div className="bg-blue-600 py-2 overflow-hidden whitespace-nowrap border-b border-blue-500 relative">
        <div className="flex animate-marquee items-center gap-12">
          {[
            ...
            <div key={i} className="flex items-center gap-2 text-caption text-[var(--text-primary)]">
          ...
          {[
            ...
            <div key={`d-${i}`} className="flex items-center gap-2 text-caption text-[var(--text-primary)] opacity-80">
              <ShieldCheck className="w-3 h-3" />
              <span>{text}</span>
            </div>
          ))}
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="bg-[var(--bg-secondary)]/50 border border-[var(--border-primary)] rounded-[2rem] p-6 md:p-8 space-y-6">
            ...
            <div className="text-center">
              <Link to="/analysis/TCS" className="inline-flex items-center gap-2 text-blue-400 text-caption hover:text-[var(--text-primary)] transition-colors">
          ...
          <div className="bg-[var(--bg-secondary)] rounded-[2rem] p-6 max-w-md w-full shadow-2xl border border-[var(--border-primary)] space-y-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            {!user ? (
              <div className="space-y-4">
                ...
                <Link to="/login" className="block w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl text-caption text-center hover:from-blue-500 hover:to-indigo-500 transition-all">
                  Sign In
                </Link>
              </div>
            ) : (
              <div className="space-y-4">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-[var(--bg-primary)] border border-[var(--border-primary)] px-4 py-3 rounded-xl text-caption text-[var(--text-primary)] outline-none focus:border-blue-500"
                  />
                  <button
                    onClick={handleRedeemVoucher}
                    disabled={redeeming}
                    className="px-5 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-500 hover:to-indigo-500 disabled:bg-slate-700 disabled:text-slate-500 rounded-xl text-caption transition-all"
                  >
