            ...
            {searchError && (
              ...
              >
                ...
                <button 
                  ...
                  className="px-6 py-2 bg-[var(--bg-primary)] text-[var(--text-primary)] text-caption rounded-xl hover:bg-rose-500 hover:text-[var(--text-primary)] transition-all whitespace-nowrap"
                >
                  Request Addition
                </button>
              </motion.div>
                             ...
                             <div className="mt-6 p-5 bg-blue-600/5 border border-blue-500/10 rounded-3xl space-y-4 relative overflow-hidden">
                                ...
                                <div className="flex items-center justify-between relative z-10">
                                   <div className="flex items-center gap-2">
                                      ...
                                      <h4 className="text-caption text-[var(--text-primary)]">Institutional Entry Plan (HNI Edge)</h4>
                                   </div>
                          ...
                          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-[var(--bg-primary)]/40 backdrop-blur-[2px] rounded-3xl p-4 text-center">
                             <div className="bg-[var(--bg-secondary)]/90 border border-[var(--border-primary)] rounded-3xl p-6 max-w-sm w-full space-y-4 shadow-2xl relative overflow-hidden">
                                ...
                                <div className="space-y-1 relative z-10">
                                   <h4 className="text-caption text-[var(--text-primary)]">PRO STRATEGY MATRIX LOCKED</h4>
                                ...
                                <div className="border-t border-[var(--border-primary)] pt-3.5 space-y-2.5 relative z-10">
                                   <div className="flex gap-1.5">
                                      <input 
                                        ...
                                        className="flex-1 bg-[var(--bg-primary)] border border-[var(--border-primary)] px-3 py-2 rounded-lg text-caption text-[var(--text-primary)] outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:outline-none focus:border-blue-500"
                                      />
                                      <button
                                        onClick={handleRedeemVoucher}
                                        disabled={redeeming}
                                        className="px-4 py-2 bg-[var(--bg-primary)] text-[var(--text-primary)] hover:bg-slate-100 disabled:bg-[var(--bg-secondary)] disabled:text-slate-700 rounded-lg text-caption transition-all"
                                      >
                                         {redeeming ? '...' : 'Apply'}
                                      </button>
                                   </div>
                    ...
                    <div className="pt-4 flex flex-col sm:flex-row gap-3 relative z-10">
                       <button 
                         onClick={() => {
                          ...
                          className="flex-1 py-3.5 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 text-[var(--text-primary)] rounded-2xl text-caption hover:from-emerald-500 hover:to-emerald-600 transition-all flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20 active:scale-95"
                        >
                       ...
                       <button 
                         onClick={() => {
                          ...
                          className="flex-1 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-[var(--text-primary)] rounded-2xl text-caption hover:from-blue-500 hover:to-indigo-500 transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 active:scale-95"
                        >
            ...
            <div className="bg-[var(--bg-primary)]/95 backdrop-blur-xl rounded-[15px] px-4 md:px-5 py-3 md:py-4">
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-1 text-blue-400">
                  <span className="text-caption">View Audit</span>
              ...
              {!teaserData && (
                <div className="flex items-center gap-2 text-[var(--text-muted)]">
                  ...
                  <span className="text-caption">Loading live audit data...</span>
                </div>
              )}
            </div>
          </Link>
