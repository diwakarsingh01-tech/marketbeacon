        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-4 space-y-5">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20">
              ...
              <span className="text-caption text-blue-400 uppercase tracking-wider">Course To Terminal Map</span>
            </div>
            ...
            <Link to="/blog/abcd-tranche-laddering-guide" className="inline-flex items-center gap-2 text-blue-400 text-caption hover:text-[var(--text-primary)] transition-colors">
              ...
              >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-2">
                    <span className="text-xs font-bold text-[var(--text-muted)] uppercase tracking-[0.3em]">Step {index + 1}</span>
