              ...
              <AnimatePresence>
                {expanded === i && (
                  <motion.div
                    ...
                    className="mt-2 p-3 rounded-xl bg-[var(--bg-primary)] border border-[var(--border-primary)] text-[10px] text-[var(--text-muted)] leading-relaxed"
                  >
                    {s.how}
                    <p className="text-[8px] font-black text-amber-400/70 uppercase tracking-widest mt-2">Educational rule. Not a signal.</p>
                    <Link to={s.blog} className="inline-flex items-center gap-1 text-blue-400 text-[8px] font-black uppercase tracking-widest mt-2 hover:text-[var(--text-primary)] transition-colors">
