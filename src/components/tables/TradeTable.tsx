      ...
      {searchTerm ? (
        <>
          ...
          <button 
            ...
            className="px-5 py-2.5 bg-slate-900 text-white rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-black transition-all shadow-md active:scale-95 border border-white/5"
          >
            Clear Search Filter
          </button>
        </>
        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button 
              ...
              className="px-4 py-2 bg-[var(--bg-secondary)] border border-[var(--border-secondary)] text-[var(--text-secondary)] rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-[var(--bg-secondary)] transition-all shadow-sm active:scale-95"
            >
              + Add Position
            </button>
            <button 
              onClick={onConnectNode}
              className="px-4 py-2 bg-slate-900 text-white rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-black transition-all shadow-md active:scale-95 border border-white/5"
            >
              Upload New Details
            </button>
            <a 
              ...
              className="px-4 py-2 bg-emerald-500/10 text-emerald-400 rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-emerald-600 hover:text-white transition-all shadow-sm border border-emerald-500/20 flex items-center space-x-1.5 group"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="px-4 py-2 bg-blue-500/10 text-blue-400 rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-blue-600 hover:text-white transition-all shadow-sm border border-blue-500/20 flex items-center space-x-1.5 group"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-3 w-3 group-hover:scale-110 transition-transform">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between bg-[var(--bg-secondary)]/50 backdrop-blur-md px-6 py-4 rounded-[2rem] border border-[var(--border-primary)] gap-4 shadow-sm">
        <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3.5 flex-1 w-full">
          ...
          <div className="relative w-full md:max-w-xs">
            ...
            <input 
              ...
              className="w-full bg-[var(--bg-secondary)] border border-[var(--border-secondary)] rounded-2xl pl-11 pr-4 py-2.5 text-xs font-bold uppercase tracking-wider focus:bg-[var(--bg-secondary)] focus:border-blue-500/20 transition-all outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:outline-none"
              value={searchTerm}
        ...
        <div className="flex items-center gap-3 shrink-0 justify-between md:justify-end w-full lg:w-auto">
          <button 
            ...
            className="flex-1 md:flex-initial flex items-center justify-center gap-3 px-5 py-2.5 bg-[var(--bg-tertiary)] text-white rounded-2xl text-xs font-bold uppercase tracking-wider hover:bg-black transition-all shadow-xl shadow-slate-900/10 group border border-white/5"
        ...
        >
           {Object.entries(visibleColumns).map(([key, isVisible]) => (
             <button 
                ...
                className={`px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all ${isVisible ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'bg-[var(--bg-secondary)] text-[var(--text-muted)] border border-[var(--border-primary)] hover:bg-[var(--bg-tertiary)]'}`}
             >
                {key}
             </button>
           ))}
                      ...
                      <div className="p-4 bg-[var(--bg-secondary)]/40 border-t border-[var(--border-primary)] space-y-4 animate-in slide-in-from-top-1 duration-200">
                         ...
                         <div className="flex items-center gap-2 pt-1">
                            <button 
                               ...
                               className={`flex-1 py-2 rounded-xl text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 border transition-all ${
                                  isStarred 
                            ...
                            <Link 
                               ...
                               className="flex-1 py-2 bg-[var(--bg-tertiary)] text-white text-xs font-bold uppercase tracking-wider rounded-xl shadow-md flex items-center justify-center gap-1 hover:bg-black transition-all"
                            >
                               <InfoIcon className="h-3.5 w-3.5" />
                               Audit details
                            </Link>
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-[var(--bg-secondary)]/50 backdrop-blur-md rounded-[2rem] border border-[var(--border-primary)] shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-[var(--bg-secondary)] border border-[var(--border-secondary)] rounded-lg text-xs font-bold uppercase tracking-wider px-3 py-2 outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:outline-none"
            >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page === 0}
              className="px-4 py-2 text-xs font-bold uppercase tracking-wider rounded-xl border border-[var(--border-secondary)] bg-[var(--bg-secondary)] text-[var(--text-secondary)] disabled:opacity-30 disabled:cursor-not-allowed hover:bg-[var(--bg-secondary)] transition-all"
            >
              Prev
            </button>
            {(() => {
